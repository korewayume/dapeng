...
CommonConv2D = partial(
    ...
    activation='relu',
    padding='same',
    kernel_regularizer=l1(1e-8),
    activity_regularizer=l1(1e-8)
)
...
def unet5(size, optimizer=None, loss=None, metrics=None, dropout_rate=0.2, load_weights=False):
    ...
    conv10 = Conv2D(1, (1, 1), activation='sigmoid', kernel_regularizer=l1(1e-8), activity_regularizer=l1(1e-8))(conv9)
